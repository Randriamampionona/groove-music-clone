...
export default function Card({ data, type }: TProps) {
  return (
    <div className="group flex flex-col items-center justify-start rounded-md w-40 h-fit bg-accent lg:bg-transparent hover:bg-accent px-2 py-1 cursor-default transition-all">
